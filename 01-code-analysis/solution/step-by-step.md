## [Week 2: Your code can only have one level of indentation.](https://williamdurand.fr/2013/06/03/object-calisthenics/#1-only-one-level-of-indentation-per-method)
